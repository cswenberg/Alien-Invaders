...
WAVE_SPEED_INCREASE = .15
#: increments speed of aliens each time one is killed
ALIEN_SPEED_INCREASE = .985
#: increments bolt speed each time alien is killed
BOLT_SPEED_INCREASE = .99
#: maximum alien speed
ALIEN_MAX_SPEED = .5
#: max bolt speed
BOLT_MAX_SPEED = 4
#: image files for powerups
POWERUP_IMAGE = ('orb1.png','orb2.png','heart.png')
#: amount of pixels powerup moves per update
POWERUP_SPEED = 2
#: width of powerup
POWERUP_WIDTH = 30
#: height of powerup
POWERUP_HEIGHT = 30
#: guaranteed to get a power up before or at this many aliens left
FIRST_POWERUP = 30
#: number of shots allowed with tribolt
TRIBOLT_SHOTS = 5
#: horizontal separation between bolts when powerup tribolt is engaged
TRIBOLT_SEP = 20
#: time for invincibility powerup
INVINCIBLE_TIME = 15
#: time of invincibility after death
RECOVERY_TIME = 3
#: penalty to score as a result of dying
SCORE_PENALTY = 100